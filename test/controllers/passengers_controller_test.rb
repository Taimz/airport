...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { email: @passenger.email, name: @passenger.name, phone_number: @passenger.phone_number } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { email: @passenger.email, name: @passenger.name, phone_number: @passenger.phone_number } }
